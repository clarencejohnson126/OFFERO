# Offero — Arbeitsanweisung für Codex (Repo-Doktrin)

> Diese Datei steuert, wie Codex in **diesem** Repo arbeitet. Sie ergänzt die globale
> `~/.Codex/AGENTS.md` (Five Pillars of Agentic Engineering). Bei Konflikt gewinnt die
...
- **Stack:** Next.js (App Router) auf Vercel · Supabase (Postgres + Storage + Auth, EU-Region)
  · Codex (Text) · Gemini (Bild) · Remotion Lambda (Video) · Stripe (Zahlung).
