...
| 4 | **Vorschau + Feinschliff** | zum „Ja" | **Feinschliff gratis/unbegrenzt** → niemand bleibt bei einem ungeliebten Ergebnis (Regret-Aversion, Art. I.3); Re-Roll 3 frei | `onboarding-cro`, `copy-editing` |
...
| 6 | **Upgrade** | Free → bezahlt | Gates **an erlebtem Wert** (Bilder=Plus, Video/Domain/Radar=Pro), nie davor; Good-Better-Best-Leiter (Price-Relativity/Anchoring); Radar als **ehrlicher** Loss-Aversion-Haken | `paywall-upgrade-cro`, `pricing-strategy` |
